// 0,初始化controller路径；
//need change;
var url = "./../AdminCityController/"
var queryUrl = "";
var saveUrl = "";
var deleteUrl ="";
var updateUrl ="";
//add url;
var provinceUrl="./../AdminCityController/fillCombobox.do";
//查询参数;
//need change;
...
$(function() {
	...
	$("#search").bind("click", function() {
		...
		queryParam={"name":name,"parentId":parentId};
		//set datagrid params;
...
function add() {
	...
	}else
	{
		...
		$.messager.prompt('添加市区', '在省份:'+$("#province").combobox('getText') +' 中添加市区:', 
				function(name){if (name){ 
				//后台添加;
				var param={"parentId":provinceId,'name':name}
